...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/HamidMolareza/TestAssist
   ```
...
by [submitting an issue on GitHub](https://github.com/HamidMolareza/TestAssist/issues). Before you create an issue,
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/HamidMolareza/TestAssist/pulls)
